#!/bin/bash
# v6c LONG: 11D vortex-only + 8k vocab + 4xH100 + 2k iters + FIRST_LAYER_NOISE=token_seeded.
...
echo "Launching v6c LONG: 11D + 8k + 4xH100 + ${ITERATIONS} iters, noise=token_seeded sigma=${FIRST_LAYER_NOISE_SIGMA}"
