#!/bin/bash
# v6b LONG: 11D vortex-only + 8k vocab + 4xH100 + 2k iters + FIRST_LAYER_NOISE=brazil.
...
echo "Launching v6b LONG: 11D + 8k + 4xH100 + ${ITERATIONS} iters, noise=brazil sigma=${FIRST_LAYER_NOISE_SIGMA}"
