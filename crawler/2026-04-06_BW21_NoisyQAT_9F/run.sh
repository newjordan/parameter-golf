...
set -euo pipefail
# ================================================================
# BW21_NoisyQAT_9F — production full run (submission-oriented)
#
# One variable vs BWX 9F: NOISY_QAT=1
#
# Usage:
#   SEED=444 NPROC_PER_NODE=8 bash crawler/2026-04-06_BW21_NoisyQAT_9F/run.sh
#   SEED=300 NPROC_PER_NODE=8 bash crawler/2026-04-06_BW21_NoisyQAT_9F/run.sh
# ================================================================
...
echo ""
echo "============================================"
echo "  BW21_NoisyQAT_9F — full run"
...
echo "  CRAWLER_QUANT_INT8=${CRAWLER_QUANT_INT8}  NOISY_QAT=${NOISY_QAT}"
echo "  log: ${LOG_TS}"
echo "============================================"
echo ""
...
echo ""
echo "============================================"
echo "  RESULT — BW21_NoisyQAT_9F seed=${SEED}"
