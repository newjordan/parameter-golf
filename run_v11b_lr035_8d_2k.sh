#!/bin/bash
# v11b lr035 8D: 2000-step production validation of NEW champion v11 lr035_8d_m2.
# Config: NUM_LAYERS=8, MLP_MULT=2, ADD_MLP=1, MATRIX_LR=0.035, MUON_MOMENTUM=0.95.
...
echo "Launching v11b_lr035_8d: 8D MLP=2 lr=0.035 validation + 4xH100 + ${ITERATIONS} iters"
