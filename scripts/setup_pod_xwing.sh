...
echo ""
echo "    cd ${WORKSPACE}"
echo "    SEED=1337 NPROC_PER_NODE=8 bash concepts/podracer/xwing/run.sh"
echo ""
echo "  Additional seeds:"
echo "    SEED=42 NPROC_PER_NODE=8 bash concepts/podracer/xwing/run.sh"
echo "    SEED=2024 NPROC_PER_NODE=8 bash concepts/podracer/xwing/run.sh"
echo ""
