#!/bin/bash
set -euo pipefail
# Nightcrawler Cubed — current legal 10-minute crawler path
#
# This is the exact seed-444 legal export stack:
#   7F+3C + brotli + loop-aware GPTQ + runtime pyminify + selective prune
