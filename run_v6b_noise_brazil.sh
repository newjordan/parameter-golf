#!/bin/bash
# v6b: 11D vortex-only + 8k vocab + 4xH100 + 2k iters + FIRST_LAYER_NOISE=brazil.
# Magnitude-proportional noise: sigma * randn * |x|^0.5. Tests whether amplifying
# noise on already-large features helps more than isotropic flat injection.
...
# v6b-specific: magnitude-proportional first-layer noise injection.
export FIRST_LAYER_NOISE="brazil"
export FIRST_LAYER_NOISE_SIGMA="0.1"

echo "Launching v6b: 11D vortex-only + 8k vocab + 4xH100 + ${ITERATIONS} iters"
