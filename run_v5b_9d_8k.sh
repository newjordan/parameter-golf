#!/bin/bash
# v5b: 9D vortex-only + 8k vocab control. Anchors how much the vocab change
# alone buys at the current depth (vs v5a's 11D).
...
echo "Launching v5b: 9D vortex-only + 8k vocab + 4xH100 + ${ITERATIONS} iters"
