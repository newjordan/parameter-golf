...
LINKED_FLAT_RECUR_LAYERS="${LINKED_FLAT_RECUR_LAYERS:-0}"
...
echo "  LINKED_FLAT_RECUR_LAYERS=${LINKED_FLAT_RECUR_LAYERS}"
...
env \
    ...
    LINKED_FLAT_RECUR_LAYERS="${LINKED_FLAT_RECUR_LAYERS}" \
